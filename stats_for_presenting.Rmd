...
ggplot(m_merged_citizen, aes(x = Var2, y = Freq , fill=Var1)) +
  geom_col(position = "fill")+ labs(title="U of R Student Application - Master's Acceptance Rate Based On Citizenship (2015 - 2022)", x = "Term Year", y = "Proportion", fill="Gender") + theme(plot.title = element_text(size=9))
...
ggplot(p_merged_citizen, aes(x = Var2, y = Freq , fill=Var1)) +
  geom_col(position = "fill")+ labs(title="U of R Student Application - PhD Acceptance Rate Based On Citizenship (2015 - 2022)", x = "Term Year", y = "Proportion", fill="Gender") + theme(plot.title = element_text(size=9))
