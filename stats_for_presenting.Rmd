...
$$
\begin{aligned}
Conclusion&:\text{The extremely small p-value 
(p < 2.2e-16) is much lower than our alpha level of significance } (\alpha = 0.05), \text{indicating that the} \\ &\text{ difference in average ages between Master's and Ph.D. students is statistically significant.} \\ &\text{Therefore, we reject the null hypothesis, H0, which stated that we don’t have enough evidence to conclude that the average of} \\ &\text{Master’s students is equal to the average of PhD students.}
\end{aligned}
$$
...
$$
\begin{aligned}
Master\;Conclusion&:\text{Since the p-value is less than significance level , we reject the null hypothesis}\\ &\text{and  suggest that there is an association between how student learnt about university} \\ &\text{and acceptance rate for Master’s Program.}\\
\\
PhD\;Conclusion&:\text{Since the p-value is greater than significance level , we  accept the null hypothesis}\\ &\text{and conclude that  there is no association between how student learnt about university}\\ &\text{and acceptance rate for PhD program.}
\end{aligned}
$$
